...
public extension UIImage {
	...
	/// EAKit: Size in bytes of UIImage
	public var bytesSize: Int {
		return UIImageJPEGRepresentation(self, 1)?.count ?? 0
	}
	
	/// EAKit: Size in kilo bytes of UIImage
	public var kilobytesSize: Int {
		return bytesSize / 1024
	}
	
	/// EAKit: UIImage with .alwaysOriginal rendering mode.
	public var original: UIImage {
		return withRenderingMode(.alwaysOriginal)
	}
	
	/// EAKit: UIImage with .alwaysTemplate rendering mode.
...
public extension UIImage {
	...
	/// EAKit: UIImage scaled to height with respect to aspect ratio.
	///
	/// - Parameters:
	///   - toHeight: new height.
	...
	/// EAKit: UIImage scaled to width with respect to aspect ratio.
	///
	/// - Parameters:
	///   - toWidth: new width.
	///   - orientation: optional UIImage orientation (default is nil).
	...
	/// EAKit: UIImage filled with color
	///
	...
	/// EAKit: UIImage tinted with color
	///
	/// - Parameters:
    ...
    /// EAKit: UIImage with rounded corners
    ///
    /// - Parameters:
...
public extension UIImage {
	...
	/// EAKit: Create UIImage from color and size.
	///
	/// - Parameters:
