...
public extension UIAlertController {
	...
	/// EAKit: Present alert view controller in the current view controller.
	///
	/// - Parameters:
	...
	/// EAKit: Add a text field to Alert
	///
	/// - Parameters:
...
public extension UIAlertController {
	...
	/// EAKit: Create new alert view controller with default OK action.
	///
	/// - Parameters:
	...
	/// EAKit: Create new error alert view controller from Error with default OK action.
	///
	/// - Parameters:
