...
public extension CGPoint {
	...
	/// EAKit: Distance from another CGPoint.
	///
	...
	/// EAKit: Distance between two CGPoints.
	///
	///     let point1 = CGPoint(x: 10, y: 10)
	///     let point2 = CGPoint(x: 30, y: 30)
...
public extension CGPoint {
	...
	/// EAKit: Subtract a CGPoints from self.
	///
	///     let point1 = CGPoint(x: 10, y: 10)
	///     let point2 = CGPoint(x: 30, y: 30)
	///     point1 -= point2
	...
	/// EAKit: Multiply a CGPoint with a scalar
	///
	///     let point1 = CGPoint(x: 10, y: 10)
	///     let scalar = point1 * 5
	...
	/// EAKit: Multiply self with a scalar
	///
	///     let point1 = CGPoint(x: 10, y: 10)
	///     point *= 5
