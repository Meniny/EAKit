...
public extension Date {
	...
	/// EAKit: Check if date is in future.
	///
	...
	/// EAKit: Check if date is in past.
	///
	...
	/// EAKit: Check if date is within today.
	///
	/// 	Date().isInToday -> true
	///
	...
	/// EAKit: Check if date is within yesterday.
	///
	...
	/// EAKit: Check if date is within tomorrow.
	///
	...
	/// EAKit: Check if date is within a weekend period.
	public var isInWeekend: Bool {
		return Calendar.current.isDateInWeekend(self)
	}
	
	/// EAKit: Check if date is within a weekday period.
	public var isWorkday: Bool {
		return !Calendar.current.isDateInWeekend(self)
	}
	
	/// EAKit: Check if date is within the current week.
	public var isInCurrentWeek: Bool {
		return Calendar.current.isDate(self, equalTo: Date(), toGranularity: .weekOfYear)
	}
	
	/// EAKit: Check if date is within the current month.
	public var isInCurrentMonth: Bool {
		return Calendar.current.isDate(self, equalTo: Date(), toGranularity: .month)
	}
	
	/// EAKit: Check if date is within the current year.
	public var isInCurrentYear: Bool {
		return Calendar.current.isDate(self, equalTo: Date(), toGranularity: .year)
	}
	
	/// EAKit: ISO8601 string of format (yyyy-MM-dd'T'HH:mm:ss.SSS) from date.
	///
	...
	/// EAKit: Nearest five minutes to date.
	///
	...
	/// EAKit: Nearest ten minutes to date.
	///
	...
	/// EAKit: Nearest quarter hour to date.
	///
	/// 	var date = Date() // "5:57 PM"
	/// 	date.minute = 34 // "5:34 PM"
	...
	/// EAKit: Nearest half hour to date.
	///
	...
	/// EAKit: Time zone used currently by system.
	///
	...
	/// EAKit: UNIX timestamp from date.
	///
...
public extension Date {
	...
	/// EAKit: Date by adding multiples of calendar component.
	///
	...
	/// EAKit: Add calendar component to date.
	///
	...
	/// EAKit: Date by changing value of calendar component.
	///
	/// 	let date = Date() // "Jan 12, 2017, 7:07 PM"
	...
	/// EAKit: Data at the beginning of calendar component.
	///
	...
	/// EAKit: Date at the end of calendar component.
	///
	...
	/// EAKit: Check if date is in current given calendar component.
	///
    ...
    public static let defaultFormatStyle = "yyyy-MM-dd HH:mm:ss.SSS"
    
    public func format(style: String = Date.defaultFormatStyle) -> String {
        let dateFormatter = DateFormatter.init()
        dateFormatter.dateFormat = style.isEmpty ? Date.defaultFormatStyle : style
	...
	/// EAKit: Date and time string from date.
	///
	...
	/// EAKit: get number of seconds between two date
	///
	...
	/// EAKit: get number of minutes between two date
	///
	/// - Parameter date: date to compate self to.
	...
	/// EAKit: get number of hours between two date
	///
	/// - Parameter date: date to compate self to.
	...
	/// EAKit: get number of days between two date
	///
	/// - Parameter date: date to compate self to.
	...
	/// EAKit: check if a date is between two other dates
	///
	/// - Parameters:
	...
	/// EAKit: check if a date is a number of date components of another date
	///
	/// - Parameters:
	...
	/// EAKit: Random date between two dates.
	///
	///     Date.random()
...
public extension Date {
	...
	/// EAKit: Create a new date form calendar components.
	///
	...
	/// EAKit: Create date object from ISO8601 string.
	///
	...
	/// EAKit: Create new date object from UNIX timestamp.
	///
	...
	/// EAKit: Create date object from Int literal
	///
