...
public extension CLLocation {
	...
	/// EAKit: Calculate the half-way point along a great circle path between the two points.
	///
	/// - Parameters:
	...
	/// EAKit: Calculate the half-way point along a great circle path between self and another points.
	///
	...
	/// EAKit: Calculates the bearing to another CLLocation.
	///
	/// - Parameters:
