...
open class Crypto {
    public struct Digest {
        ...
        public var checksum: String {
            return Crypto.MD5.encodeMD5(digest: self.digest)
        }
    }
    ...
    open class MD5 {
        ...
        open static func md5(_ bytes: [Byte]) -> Crypto.Digest {
            // Initialization
            let s: [Word] = [
        ...
        public static func encodeMD5(digest: [Byte]) -> String {
            assert(digest.count == 16)
...
public extension String {
    public var md5String: String {
        return Crypto.MD5.encodeMD5(digest: md5Digest)
    }
    
    public var md5Digest: [Byte] {
        let bytes = [Byte](self.utf8)
        let digest = Crypto.MD5.md5(bytes)
        return digest.digest
    }
}
