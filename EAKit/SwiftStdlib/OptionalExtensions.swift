...
public extension Optional {
	...
	/// EAKit: Get self of default value (if self is nil).
	///
	///		let foo: String? = nil
	...
	/// EAKit: Runs a block to Wrapped if not nil
	///
	///		let foo: String? = nil
	...
	/// EAKit: Assign an optional value to a variable only if the value is not nil.
	///
