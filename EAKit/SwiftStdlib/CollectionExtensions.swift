...
public extension Collection {
	...
	/// EAKit: Performs `each` closure for each element of collection in parallel.
	///
	...
	/// EAKit: Safe protects the array from out of bounds by use of optional.
	///
	///		let arr = [1, 2, 3, 4, 5]
	///		arr[safe: 1] -> 2
	///		arr[safe: 10] -> nil
