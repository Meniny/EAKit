...
public extension FloatingPoint {
	...
	/// EAKit: Random number between two number.
	///
	/// - Parameters:
	...
	/// EAKit: Random number in a closed interval range.
	///
...
public extension FloatingPoint {
	...
	/// EAKit: Created a random number between two numbers.
	///
	/// - Parameters:
	///   - min: minimum number to start random from.
	///   - max: maximum number random number end before.
	...
	/// EAKit: Create a random number in a closed interval range.
	///
	/// - Parameter range: closed interval range.
