...
public extension Array where Element: Numeric {
	...
	/// EAKit: Sum of all elements in array.
	///
	///		[1, 2, 3, 4, 5].sum() -> 15
	///
...
public extension Array where Element: FloatingPoint {
	...
	/// EAKit: Average of all elements in array.
	///
...
public extension Array {
	...
	/// EAKit: Insert an element at the beginning of array.
	///
	...
	/// EAKit: Insert an element to the end of array.
	///
	...
	/// EAKit: Safely Swap values at index positions.
	///
	...
	/// EAKit: Swap values at index positions.
	///
	...
	/// EAKit: Get first index where condition is met.
	///
	...
	/// EAKit: Get last index where condition is met.
	///
	...
	/// EAKit: Get all indices where condition is met.
	///
	...
	/// EAKit: Check if all elements in array match a conditon.
	///
	...
	/// EAKit: Check if no elements in array match a conditon.
	///
	...
	/// EAKit: Get last element that satisfies a conditon.
	///
	...
	/// EAKit: Filter elements based on a rejection condition.
	///
	...
	/// EAKit: Get element count based on condition.
	///
	...
	/// EAKit: Iterate over a collection in reverse order. (right to left)
	///
	...
	/// EAKit: Calls given closure with each element where condition is true.
	///
	...
	/// EAKit: Filtered and map in a single operation.
	///
	...
	/// EAKit: Take element of Array while condition is true.
	///
	...
	/// EAKit: Skip elements of Array while condition is true.
	///
	...
	/// EAKit: Calls given closure with an array of size of the parameter slice where condition is true.
	///
	...
	/// EAKit: Returns an array of slices of length "size" from the array.  If array can't be split evenly, the final slice will be the remaining elements.
	///
	...
	/// EAKit: Group the elements of the array in a dictionary.
	///
	...
	/// EAKit: Separates an array into 2 arrays based on a predicate.
	///
	...
	/// EAKit: Returns a new rotated array by the given places.
	///
	...
	/// EAKit: Rotate the array by the given places.
	///
	...
	/// EAKit: Shuffle array. (Using Fisher-Yates Algorithm)
	///
	...
	/// EAKit: Shuffled version of array. (Using Fisher-Yates Algorithm)
	///
	...
	/// EAKit: Return a sorted array based on an optional keypath.
	///
	...
	/// EAKit: Return a sorted array based on a keypath.
	///
	/// - Parameter path: Key path to sort. The key path type must be Comparable.
	/// - Parameter ascending: If order must be ascending.
	/// - Returns: Sorted array based on keyPath.
	...
	/// EAKit: Sort the array based on an optional keypath.
	///
	/// - Parameter path: Key path to sort. The key path type must be Comparable.
	/// - Parameter ascending: If order must be ascending.
	...
	/// EAKit: Sort the array based on a keypath.
	///
	/// - Parameter path: Key path to sort. The key path type must be Comparable.
	/// - Parameter ascending: If order must be ascending.
	public mutating func sort<T: Comparable>(by path: KeyPath<Element, T>, ascending: Bool = true) {
...
public extension Array where Element: Equatable {
	...
	/// EAKit: Check if array contains an array of elements.
	///
	...
	/// EAKit: Remove all instances of an item from array.
	///
	...
	/// EAKit: Remove all instances contained in items parameter from array.
	///
	...
	/// EAKit: Remove all duplicate elements from Array.
	///
	...
	/// EAKit: Return array with all duplicate elements removed.
	///
	...
	/// EAKit: First index of a given item in an array.
	///
	...
	/// EAKit: Last index of element in array.
	///
