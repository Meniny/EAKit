...
//  EAKit
//
//  Created by Elias Abel on 8/24/16.
...
public extension Dictionary {
	...
	/// EAKit: Check if key exists in dictionary.
	///
	...
	/// EAKit: Remove all keys of the dictionary.
	///
	...
	/// EAKit: JSON Data from dictionary.
	///
	...
	/// EAKit: JSON String from dictionary.
	///
	...
	/// EAKit: Count dictionary entries that where function returns true.
	///
...
public extension Dictionary {
	...
	/// EAKit: Merge the keys/values of two dictionaries.
	///
	...
	/// EAKit: Append the keys and values from the second dictionary into the first one.
	///
	...
	/// EAKit: Remove contained in the array from the dictionary
	///
...
public extension Dictionary where Key: ExpressibleByStringLiteral {
	...
	/// EAKit: Lowercase all keys in dictionary.
	///
